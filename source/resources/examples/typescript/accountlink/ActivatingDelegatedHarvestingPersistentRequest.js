...
const remoteAccount = bitxor_sdk_1.Account.createFromPrivateKey(
...
const vrfAccount = bitxor_sdk_1.Account.createFromPrivateKey(
...
const announcerAccount = bitxor_sdk_1.Account.createFromPrivateKey(
...
const nodeAccount = bitxor_sdk_1.PublicAccount.createFromPublicKey(
  nodePublicTLSKey,
  networkType,
);
/* end block 01 */
/* start block 02 */
const persistentDelegationRequestTransaction = bitxor_sdk_1.PersistentDelegationRequestTransaction.createPersistentDelegationRequestTransaction(
