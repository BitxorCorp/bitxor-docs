...
The product receives its quality approval :doc:`token <token>` only when its blockchain record shows it has a production date, safety inspection, and was shipped at the correct temperature.
