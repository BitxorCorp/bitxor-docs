...
import { TokenId, UInt64 } from 'bitxor-sdk';
...
export interface DBService {
  ...
  /**
   * Gets the user relative amount of tokenId tokens.
   * @param uuid User unique identifier.
   * @param tokenId Token identifier.
   * @returns number
   */
  getUserAmount(uuid: string, tokenId: TokenId): number;
  ...
  /**
   * Records bitxor deposits for a given user.
   ...
   * @param uuid User unique identifier.
   * @param amount Absolute amount of bitxor tokens.
   * @param hash Transaction hash.
   * @param index Transaction index within an aggregate transaction.
   * @returns boolean
   */
  ...
  /**
   * Records bitxor withdrawal for a given user.
   * @param uuid User unique identifier.
   * @param amount Absolute amount of bitxor tokens.
   * @param hash Transaction hash.
   * @returns boolean
