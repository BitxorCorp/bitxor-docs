...
**Template**: `README <https://github.com/bitxorcorp/bitxor-sdk-typescript-javascript/blob/main/README.md>`_
...
1. `Fork <https://help.github.com/articles/fork-a-repo>`_ and clone `symbl-docs repository <https://github.com/bitxorcorp/bitxor-docs>`__.
...
3. Adapt every `TypeScript snippet <https://github.com/bitxorcorp/bitxor-docs/tree/main/source/resources/examples/typescript>`__ using the new SDK.
